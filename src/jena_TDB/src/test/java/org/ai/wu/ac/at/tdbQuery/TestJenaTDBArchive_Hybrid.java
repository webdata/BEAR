 ...
 *
 */
public class TestJenaTDBArchive_Hybrid {

	JenaTDBArchive jenaArchive;

	public TestJenaTDBArchive_Hybrid() throws FileNotFoundException, InterruptedException, ExecutionException {

		// Start Archive
		jenaArchive = new JenaTDBArchive_Hybrid();
		URL resourceUrl = this.getClass().getResource(FileSystems.getDefault().getSeparator() + "testHybrid/tdbTest");
	...
	public void testbulkAllMatQuerying() throws InterruptedException, ExecutionException, FileNotFoundException, IOException {
		...
		URL queryurl = this.getClass().getResource(FileSystems.getDefault().getSeparator() + "testHybrid/testQueryDynamic.txt");
	...
	public void testbulkAllMatQuerying_SP_Pattern() throws InterruptedException, ExecutionException, FileNotFoundException, IOException {
		...
		URL queryurl = this.getClass().getResource(FileSystems.getDefault().getSeparator() + "testHybrid/testQueryDynamic_SP.txt");
	...
	public void testbulkAllMatQuerying_SO_Pattern() throws InterruptedException, ExecutionException, FileNotFoundException, IOException {
		...
		URL queryurl = this.getClass().getResource(FileSystems.getDefault().getSeparator() + "testHybrid/testQueryDynamic_SO.txt");
	...
	public void testbulkAllMatQuerying_PO_Pattern() throws InterruptedException, ExecutionException, FileNotFoundException, IOException {
		...
		URL queryurl = this.getClass().getResource(FileSystems.getDefault().getSeparator() + "testHybrid/testQueryDynamic_PO.txt");
	...
	public void testbulkAllMatQuerying_SPO_Pattern() throws InterruptedException, ExecutionException, FileNotFoundException, IOException {
		...
		URL queryurl = this.getClass().getResource(FileSystems.getDefault().getSeparator() + "testHybrid/testQueryDynamic_SPO.txt");
